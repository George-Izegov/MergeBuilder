                ...
                if (Target.Platform == UnrealTargetPlatform.IOS)
                {
                  ...
                  /*  PublicAdditionalFrameworks.Add(
                        new Framework(
                            ...
                            "../../ThirdParty/iOS/GoogleAppMeasurement.framework.zip"
                        )
                    );*/
                    ...
                    PublicAdditionalFrameworks.Add(
                        new Framework(
                            "GoogleUtilities",
                            "../../ThirdParty/iOS/GoogleUtilities.framework.zip"
                        )
                    );
                    ...
                    PublicAdditionalFrameworks.Add(
                        new Framework(
                            "nanopb",
                            "../../ThirdParty/iOS/nanopb.framework.zip"
                        )
                    );
                  ...
                  /*  PublicAdditionalFrameworks.Add(
                        new Framework(
                            "PromisesObjC",
                            "../../ThirdParty/iOS/PromisesObjC.framework.zip"
                        )
                    );*/
                    ...
                    PublicAdditionalFrameworks.Add(
                        new Framework(
                            "FBAudienceNetwork",
                            "../../ThirdParty/iOS/FBAudienceNetwork.framework.zip"
                        )
                    );
