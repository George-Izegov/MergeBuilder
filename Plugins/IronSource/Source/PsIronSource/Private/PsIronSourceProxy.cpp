...
void UPsIronSourceProxy::ShowRewardedVideo(const FString& PlacementName, const FString& ParamKey, const FString& ParamValue) const
{
	UE_LOG(LogPsIronSource, Warning, TEXT("%s: Null proxy used"), *PS_FUNC_LINE);
	//EIronSourceEventType::VideoShowFailed
	VideoStateDelegate.Broadcast(1);
}
